 ...
 /*Завантаження даних в таблицю*/
  ...
  INSERT INTO library.dbo.library_table(num, codeNum, new, name, price, publisher, pages, form, publish_date, circulation, topic, category) VALUES   (58, 3932, 0, 'Як   перетворити персональний компютер на вимірювальний комплекс', 7.65, 'ДМК', 144, '60x88/16', '1999-09-26', 5000, 'Використання ПК в цілому', 'Інші книги'),
